 ...
 * system property {@code org.joda.money.CurrencyUnitDataProvider} which should
 * be the fully qualified class name of the provider. The default provider loads
 * the first resource named {@code /org/joda/money/MoneyData.csv} on the
 * classpath.
 * <p>
...
public final class CurrencyUnit implements Comparable<CurrencyUnit>, Serializable {
	...
	static {
		...
		try {
			try {
				...
				Class<? extends CurrencyUnitDataProvider> cls = CurrencyUnit.class.getClassLoader().loadClass(clsName).asSubclass(CurrencyUnitDataProvider.class);
	 ...
	 * <p>
	 * This class only permits known currencies to be returned. To achieve this,
	 * all currencies have to be registered in advance.
	 * <p>
	 * Since this method is public, it is possible to add currencies in
	 * application code. It is recommended to do this only at startup, however it
	 * is safe to do so later as the internal implementation is thread-safe.
	 * 
	 * @param currencyCode
	 *          the currency code, not null
	 * @param numericCurrencyCode
	 *          the numeric currency code, -1 if none
	 * @param decimalPlaces
	 *          the number of decimal places that the currency normally has, from
	 *          0 to 9 (normally 0, 2 or 3), or -1 for a pseudo-currency
	 * @param countryCodes
	 *          the country codes to register the currency under, not null
	 * @return the new instance, never null
	 * @throws IllegalArgumentException
	 *           if the code is already registered, or the specified data is
	 *           invalid
	 */
	 ...
	 * is safe to do so later as the internal implementation is thread-safe.
	 * <p>
	 * This method uses a flag to determine whether the registered currency must
	 * be new, or can replace an existing currency.
	 * 
	 * @param currencyCode
	 *          the currency code, not null
	 * @param numericCurrencyCode
	 ...
	 *          0 to 9 (normally 0, 2 or 3), or -1 for a pseudo-currency
	 * @param countryCodes
	 *          the country codes to register the currency under, use of ISO-3166
	 *          is recommended, not null
	 * @param force
	 *          true to register forcefully, replacing any existing matching
	 *          currency, false to validate that there is no existing matching
	 *          currency
	 * @return the new instance, never null
	 * @throws IllegalArgumentException
	 *           if the code is already registered and {@code force} is false; or
	 *           if the specified data is invalid
	 */
	 ...
	 * <p>
	 * The numeric code is an alternative to the three letter code. This method is
	 * lenient and does not require the string to be left padded with zeroes.
	 * 
	 * @param numericCurrencyCode
	 *          the currency code, not null
	 * @return the singleton instance, never null
	...
	public static CurrencyUnit ofNumericCode(String numericCurrencyCode) {
		...
		case 2:
			return ofNumericCode((numericCurrencyCode.charAt(0) - '0') * 10 + numericCurrencyCode.charAt(1) - '0');
		case 3:
			return ofNumericCode((numericCurrencyCode.charAt(0) - '0') * 100 + (numericCurrencyCode.charAt(1) - '0') * 10 + numericCurrencyCode.charAt(2) - '0');
		default:
	 ...
	 * 
	 * @param numericCurrencyCode
	 *          the numeric currency code, not null
	 * @return the singleton instance, never null
	 * @throws IllegalCurrencyException
	 *           if the currency is unknown
	 */
	...
	/**
	 * Obtains an instance of {@code CurrencyUnit} for the specified ISO-3166
	 * country code.
	 * <p>
	 * Country codes should generally be in upper case. This method is case
	 * sensitive.
	 * 
	 * @param countryCode
	 *          the country code, typically ISO-3166, not null
	 * @return the singleton instance, never null
	 * @throws IllegalCurrencyException
	 *           if the currency is unknown
	 */
	...
	// -----------------------------------------------------------------------
	/**
	 * Obtains an instance of {@code CurrencyUnit} for the specified currency
	 * code.
	 * <p>
	 ...
	 * <p>
	 * This formats the numeric code as a three digit string prefixed by zeroes if
	 * necessary. If there is no valid code, then an empty string is returned.
	 * 
	 ...
	 * <p>
	 * A currency is typically valid in one or more countries. The codes are
	 * typically defined by ISO-3166. An empty set indicates that no the currency
	 * is not associated with a country code.
	 * 
	 ...
	 * 
	 * @return the fractional digits, from 0 to 9 (normally 0, 2 or 3), or -1 for
	 *         pseudo-currencies
	 */
	 ...
	 * <p>
	 * If this currency doesn't have a JDK equivalent, then the currency code is
	 * returned.
	 * <p>
	 * This method matches the API of {@link Currency}.
	 * 
	 ...
	 * 
	 * @param other
	 *          the other currency, not null
	 * @return negative if earlier alphabetically, 0 if equal, positive if greater
	 *         alphabetically
	 */
