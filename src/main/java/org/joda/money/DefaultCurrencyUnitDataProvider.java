 ...
 * <p>
 * This reads currencies from two files. Firstly it reads the mandatory resource
 * named {@code /org/joda/money/MoneyData.csv}. Then it reads the optional
 * resource named {@code /org/joda/money/MoneyDataExtension.csv}. Both will be
 * read as the first found on the classpath. The second file may replace entries
 * in the first file.
 */
class DefaultCurrencyUnitDataProvider extends CurrencyUnitDataProvider {
	 ...
	 * @param isNecessary
	 *          whether or not the file is necessary
	 * @throws Exception
	 *           if a necessary file is not found
	 */
